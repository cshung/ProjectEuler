...
namespace Problem081
{
    class Program
    {
        ...
        {
            string matrixString = EulerUtil.ReadResourceAsString("Problem081.matrix.txt");
            int size = 80;
            ...
            Tuple<Tuple<int, int>, Tuple<int, int>, int>[] edges = new Tuple<Tuple<int, int>, Tuple<int, int>, int>[(size - 1) * size * 2];
            c = 0;
